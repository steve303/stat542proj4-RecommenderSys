...
Since we are recommending by genre, any movie which is listed under the selected genre will be considered for recommendation. 
 ...
 we are attempting to accomplish by using this formula is to obtain the ratings of movies according to their Bayesian estimate. This takes into account the number of reviews as well as the ratings in those reviews. Consider the following example reviews:
